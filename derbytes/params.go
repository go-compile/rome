...
var signatureAlgorithmDetails = []struct {
	...
	{PureEd25519, "Ed448", oidSignatureEd448, Ed448, crypto.Hash(0) /* no pre-hashing */},
}
...
var (
	...
	oidNamedCurveBrainpoolP384r1 = asn1.ObjectIdentifier{1, 3, 840, 10045, 1, 11}
	oidNamedCurveBrainpoolP384t1 = asn1.ObjectIdentifier{1, 3, 840, 10045, 1, 12}
	oidNamedCurveBrainpoolP512r1 = asn1.ObjectIdentifier{1, 3, 840, 10045, 1, 13}
	oidNamedCurveBrainpoolP512t1 = asn1.ObjectIdentifier{1, 3, 840, 10045, 1, 14}
)
...
func namedCurveFromOID(oid asn1.ObjectIdentifier) elliptic.Curve {
	...
	case oid.Equal(oidNamedCurveBrainpoolP224r1):
		return brainpool.P224r1()
	case oid.Equal(oidNamedCurveBrainpoolP224t1):
		return brainpool.P224t1()
...
func oidFromNamedCurve(curve elliptic.Curve) (asn1.ObjectIdentifier, bool) {
	...
	case brainpool.P224r1():
		return oidNamedCurveBrainpoolP224r1, true
	case brainpool.P224t1():
		return oidNamedCurveBrainpoolP224t1, true
