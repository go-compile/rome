...
func TestASN1ParseP521(t *testing.T) {
	k, err := p521.Generate()
	if err != nil {
		t.Fatal(err)
	}
...
func TestASN1ParseEd25519(t *testing.T) {
	k, err := ed25519.Generate()
	if err != nil {
		t.Fatal(err)
	}
...
func TestASN1ParseEd448(t *testing.T) {
	k, err := ed448.Generate()
	if err != nil {
		t.Fatal(err)
	}
...
func TestASN1ParseBrainpoolP256r1(t *testing.T) {
	k, err := brainpool.GenerateP256r1()
	if err != nil {
		t.Fatal(err)
	}
